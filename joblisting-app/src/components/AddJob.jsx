...
function AddJob() {
  ...
  return (
    ...
    >
      {({ handleChange, touched, errors, setFieldValue }) => {
        return (
          <>
            <Form className="grid container mx-auto mt-6 grid-cols-3 max-md:grid-cols-1 max-lg:grid-cols-2 place-items-center gap-7 grid-rows-2  ">
